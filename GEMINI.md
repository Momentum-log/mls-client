# Gemini Instructions for GitHub Copilot for this project: Momentum Logistics Service
...
- **DO NOT** modify the `global.css` only instruct on what needs to be added there.
- **DO NOT** create a `tailwind.config.js` file the `global.css` already has all necessary configurations.
- **NEVER** commit any changes without confirmations.
